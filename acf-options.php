...
WordPress can hold and display many different types of content. A single item of such a content is generally called a post, although post is also a specific post type. Internally, all the post types are stored in the same place, in the wp_posts database table, but are differentiated by a column called post_type.', 'wpdevhelper'),
    ...
    array (
      ...
      'name' => 'wpdevhelperWPHead-favicon',
      'type' => 'image',
      'instructions' => __('Send an image with 32px wide per 32px height. Send an image with the extension ICO. You can use http://icoconvert.com/ to convert your .png files to .ico if you want.', 'wpdevhelper'),
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
    ...
    array (
      ...
      'label' => __('Apple Touch Icon iPhone', 'wpdevhelper'),
      'name' => 'wpdevhelperWPHead-apple_touch_icon-iphone',
      'type' => 'image',
    ...
    array (
      ...
      'max_size' => '',
      'mime_types' => '',
      'key' => 'field_36d596e25bas',
      'label' => __('Apple Touch Icon iPad', 'wpdevhelper'),
      'name' => 'wpdevhelperWPHead-apple_touch_icon-ipad',
      'type' => 'image',
